...
/*
 ...
 int answer = 0;
        ...
        ArrayList <Integer> lostArr = new ArrayList<Integer>(); //도난당한 친구들
        ArrayList<Integer> reserveArr=new ArrayList<Integer>(); // 여분 가지고온 친구들

        BufferedReader bf = new BufferedReader(new InputStreamReader(System.in));
        try {
            int n = Integer.parseInt(bf.readLine());//총 학생수
            String lost=bf.readLine();//도난 24
            String reserve=bf.readLine();//여분 35
